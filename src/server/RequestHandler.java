    ...
    private String handleGet(HttpExchange httpExchange) throws IOException {
      ...
      private String handleDelete(HttpExchange httpExchange){
        ...
        if (query != null) {
          ...
          if (year != null) {
            ...
            System.out.println("Delete entry {" + value + "," + year + "}");
          } else {
            response = "No data found for " + value;
          }
        }
      ...
      private String handlePut(HttpExchange httpExchange){
        ...
        String language = postData.substring(
          ...
          String yearInMap = data.get(language); // Retrieve data from hashmap
          if (yearInMap != null) {
            data.put(language, year);
            response = "Updated entry {" + language + ", " + year + "} (previous year:" + yearInMap + ")";
            System.out.println("Updated entry {" + language + ", " + year + "} (previous year:" + yearInMap + ")");
          } else {
